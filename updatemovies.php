...
if($response){
	while($row = mysqli_fetch_array($response)){
		echo '<b><a href="updatethis.php?id='.$row['mvid'] .'">'. $row['title'] .'</a>'."   ".$row['releasedate'] . '</b><br/><p>' . $row['summary'] . '</p><br/>';
	}
} else {
...
<body>
	...
	<div class="searchbar">
		<form action="updatemovies.php" method="post">
			<input type="text" name="search" placeholder="Search for a movie to update...">
			<select name = "Search">
...
if($response){
	while($row = mysqli_fetch_array($response)){
		...
		echo '<b><a href="updatethis.php?id='.$row['mvid'] .'">'. $row['title'] ."                                                                   ".$row['releasedate'] . '</b><br/><p>' . $row['summary'] . '</p></a>';
		echo '</div>';
	}
} else {
	echo 'Could not issue query';
